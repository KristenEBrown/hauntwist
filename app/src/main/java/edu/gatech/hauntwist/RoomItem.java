...
public enum RoomItem {
    ...
    PILLBOTTLE("pill bottle", "The bottle contains cyanide! It looks like there's a splash of " +
    ...
    PILLBOTTLEEMPTY("empty pill bottle", "It is the same bottle as before, but now it is empty! What could Madeline have done with the rest of the cyanide?");
